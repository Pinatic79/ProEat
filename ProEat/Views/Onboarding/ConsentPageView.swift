                ...
                VStack(spacing: 30) {
                    ...
                    VStack(alignment: .leading, spacing: 25) {
                        ConsentCheckbox(
                            ...
                            text: "I agree to this app's Terms and Conditions and Privacy Policy."
                        )
                        
                        ConsentCheckbox(
                            isChecked: $agreedToGuidance,
                            text: "I agree to use this app as a general guidance tool, not as a substitute for professional medical advice."
                        )
                        
                        ConsentCheckbox(
                            isChecked: $agreedToUnderstanding,
                            text: "I understand that this app is not intended to diagnose, treat, or replace professional advice."
                        )
                    }
                    ...
                    Button(action: {
                        ...
                        print("Onboarding complete. Navigate to main page.")
                    }) {
                        Text("Let's Go")
